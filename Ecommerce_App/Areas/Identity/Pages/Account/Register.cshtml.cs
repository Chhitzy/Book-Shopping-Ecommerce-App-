...
namespace Ecommerce_App.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            //Custom Columns, More Data Required when registering not just email 
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                CompanyList = SP.List<Company>(SD.GetCompanies).Select(cl=> new SelectListItem()
                {
                    Text = cl.Name,
                ...
                RoleList = new List<SelectListItem>{
                    new SelectListItem{Text = SD.Role_Admin, Value = SD.Role_Admin},
                     new SelectListItem{Text = SD.Role_Individual, Value = SD.Role_Individual},
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //{
                    //    await _userManager.AddToRoleAsync(user, SD.Role_Individual);//For Now Admin but change to individual role later
                    //}
